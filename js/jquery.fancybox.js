  ...
  $.extend(F, {
    ...
    defaults: {
      ...
      tpl: {
        ...
        closeBtn:
          '<a title="ë‹«ê¸°" class="fancybox-item fancybox-close" href="javascript:;"></a>',
        next: '<a title="ë‹¤ìŒ" class="fancybox-nav fancybox-next" href="javascript:;"><span></span></a>',
        prev: '<a title="ì´ì „" class="fancybox-nav fancybox-prev" href="javascript:;"><span></span></a>',
      },
